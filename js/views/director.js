...
export function loadCollaborativeProjectsForDirector() {
    ...
    // 🔥 LIMPIAR SUSCRIPCIÓN ESPECÍFICA DEL DIRECTOR
        ...
        .onSnapshot(snap => {
            ...
            snap.forEach(doc => {
                ...
                if (isCompleted) {
                    ...
                    console.log("✅ Director: Proyecto completado detectado:", project.name);
                }
                
                // 🔥 NUEVO: Mostrar badge de completado
                ...
                el.innerHTML += `
                    <div class="collaborative-project-item ${isCompleted ? 'completed' : ''}">
                        ...
                        <!-- 🔥 SECCIÓN DE COMPLETADO MEJORADA -->
                        ${isCompleted ? `
            ...
            updateCompletedProjectsCounter(completedProjectsCount, snap.size);
...
// 🔥 NUEVA FUNCIÓN: Actualizar contador de proyectos completados
